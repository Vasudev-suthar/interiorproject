...
export default function Footer (){
  return(
    <div className="bg-tertiary">
      <div className="container lg:grid lg:grid-cols-2 py-14 px-8">
        ...
        >
          ...
          <p className="pt-4 text-gray-500">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo atque, iste molestiae quae dolore tempora dolorem facere reprehenderit officia dicta mollitia earum dignissimos pariatur! Perspiciatis sed dicta molestias nam distinctio?
          </p>
        </motion.div>
      </div>
